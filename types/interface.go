...
type DSLParser interface {
	Parse(op OpType, where *ConditionExpr, set *ConditionExpr) (string, []interface{}, error)
	ParseAndCache(op OpType, where *ConditionExpr, set *ConditionExpr) (string, []interface{}, error)
}
